  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="bg-white rounded-xl shadow-lg overflow-hidden">
        {/* Header */}
        <div className="bg-gradient-to-r from-sky-600 to-sky-700 px-6 py-8 text-white">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-2xl font-bold">Hồ sơ quản trị</h1>
              <p className="text-sky-100">Quản lý thông tin cá nhân và tài khoản</p>
            </div>
          </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <div className="px-3 py-2 bg-slate-50 rounded-lg text-slate-700 min-h-[80px]">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-6 w-full max-w-md mx-4">
            <h3 className="text-lg font-semibold text-slate-800 mb-4 flex items-center">
              <KeyIcon className="w-5 h-5 mr-2 text-sky-600" />
              Đổi mật khẩu
            </h3>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500 pr-10"
